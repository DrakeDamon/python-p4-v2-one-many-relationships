...
with app.app_context():
    ...
    uri = Employee(name="Uri Lee", hire_date=date(2022, 5, 17))
    tristan = Employee(name="Tristan Tal", hire_date=date(2020, 1, 30))
    ...
    uri_onboarding = Onboarding(
        orientation=datetime(2023, 3, 27),
        employee=uri
    )
    tristan_onboarding = Onboarding(
        orientation=datetime(2020, 1, 20, 14, 30),
        forms_complete=True,
        employee=tristan
    )
